...
# A convenient built-in seaborn dataset
...
# sort_values with key=abs ensures strongest magnitude correlations are ranked
...
# We use .head(2) because the values are sorted by absolute magnitude
...
# This saves plots in the same folder as this script
